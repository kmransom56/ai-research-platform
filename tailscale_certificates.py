...
class TailscaleHTTPSManager:
    def __init__(self, tailnet_domain: str, machine_ip: str = "100.123.10.72"):
        ...
        self.applications = {
            ...
            "webhook": {"port": 11002, "path": "/health"},
            "portscanner": {"port": 11010, "path": ""},
            "nginx-manager": {"port": 11080, "path": ""},
            "http-gateway": {"port": 11081, "path": ""},
            "https-gateway": {"port": 11082, "path": ""},
            "vscode": {"port": 57081, "path": ""},
            "fortinet": {"port": 3001, "path": ""},
    ...
    def create_subdomain_certificates(self) -> bool:
        ...
        for app_name in self.applications:
            ...
            try:
                ...
                logger.warning(f"Failed to create certificate for {subdomain}: {e.stderr}")
                continue
...
"""
    ...
    def deploy_configuration(self):
        ...
        Path("./docker-compose.override.yml").write_text(self.create_docker_compose_override())
        ...
        logger.info("3. Add renewal script to crontab: '0 2 * * 0 /path/to/renew-certificates.sh'")
        logger.info("4. Add monitoring to crontab: '0 9 * * * /path/to/check-certificates.py'")
