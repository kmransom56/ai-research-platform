#!/bin/bash
# User-Friendly Platform Management Script
...
show_status() {
    ...
    local services=(
        ...
        "Nginx Proxy Manager|http://100.123.10.72:11082/"
    ...
    print_status "INFO" "   🔧 Nginx Proxy Manager: http://100.123.10.72:11082"
    print_status "INFO" "   📊 ntopng Network Monitor: http://100.123.10.72:8888"
    print_status "INFO" "   🧠 GenAI Stack Frontend: http://100.123.10.72:8505"
    print_status "INFO" "   📊 Neo4j Database: http://100.123.10.72:7474"
...
show_help() {
    ...
    echo "  • 🔧 Nginx Proxy Manager: http://100.123.10.72:11082"
