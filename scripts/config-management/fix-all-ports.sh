...
declare -A PORT_MAP=(
    ["11000"]="11000"  # Chat Copilot Frontend -> Backend
    ["11000"]="11000"  # Old backend -> New backend
    ["11001"]="11001"   # Old AutoGen -> New AutoGen
    ["11003"]="11003"   # Old Magentic-One -> New Magentic-One
    ["11002"]="11002"   # Old webhook -> New webhook
    ["11010"]="11010"  # Old port scanner -> New port scanner
    ["11080"]="11080"   # Old nginx -> New nginx
)

OLD_PORTS=(11000 11000 11001 11003 11002 11010 11080)
