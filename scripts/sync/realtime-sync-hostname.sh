...
print_banner() {
    ...
    echo \"🎮 Backup: ubuntuaicodeserver-2 (ubuntuaicodeserver-2) - High GPU RAM\"
    echo \"==============================================================================\"
    echo
}
...
SYNC MODES:
    --to-backup       Sync changes TO backup server (ubuntuaicodeserver-2)
